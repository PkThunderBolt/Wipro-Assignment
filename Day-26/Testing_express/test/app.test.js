...
// returns "Hello World!" with a 200 status code. We used supertest to make a GET
// request to the app and chai to assert the response. The tests can be run using
// the command "npm test" as defined in package.json.
