# ⚡ MongoDB Time-Series Demo — GreenPulse Energy

A complete demo showing how to model, query, and optimize **time-series data** in **MongoDB**.  
This project simulates energy readings from IoT smart meters across multiple locations — analyzing usage trends, temperatures, and performance optimization.

---

## 🌍 Demo Overview

**Database:** `SmartEnergyMonitoring`  
**Collection:** `GreenPulseEnergy` _(Time-Series Collection)_

### ✨ Features

- ⏱️ Time-based data modeling using MongoDB Time-Series collections
- 📊 Aggregation pipelines for analytics
- ⚙️ Query optimization using indexes
- 🧠 Visualization-ready outputs for dashboards

---

## 🏗️ Steps to Create the Time-Series Collection
